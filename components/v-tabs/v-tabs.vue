 ...
 * @property {String} activeColor = '#0faeff' 选中文字颜色
 ...
 * @property {String} lineColor = '#0faeff' 下划线的颜色
 * @property {Number} lineScale = 0.5 下划线的宽度缩放比例
 * @property {String} lineRadius = '10rpx' 下划线圆角
 * @property {Boolean} pills = [true | false] 是否胶囊样式
 * @property {String} pillsColor = '#0faeff' 胶囊背景色
  ...
  methods: {
    ...
    getTabItemWidth () {
      ...
      query.selectAll('.v-tabs__container-item').boundingClientRect((data) => {
        ...
        // 缩放后的滑块宽度
        this.lineWidth = currentWidth * this.lineScale * 1.5
        // 滑块作移动的位置
