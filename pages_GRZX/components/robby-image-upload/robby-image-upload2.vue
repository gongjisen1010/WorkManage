	...
	<view class="imageUploadContainer">
		<view class="imageUploadList">
			...
			<view v-if="isShowAdd" class="imageUpload" @tap="selectImage">
					<image src="../../../static/GRZX/camera.png" style="width: 69upx; height: 56upx;padding-left: 47upx;padding-top: 34upx;"></image>
				<text style="font-size: 28upx;color: #999999;padding-left: 28upx;padding-top: 15upx;">添加图片</text>
			</view>
		</view>
...
<style>
	.imageUploadContainer{
		padding: 10upx 5upx;
		margin: 10rpx 10rpx 29rpx 16rpx
	}
